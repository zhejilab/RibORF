...
Example commands: 
3a. Download an example ribosome profiling dataset from GEO database using fastq-dump command line (available from the NIH software sratoolkit, https://www.ncbi.nlm.nih.gov/sra/docs/toolkitsoft/).  
...
7. Run “readDist.pl” and check the corrected read locations around start and stop codons of canonical ORFs. This step is to check whether read locations after offset correction show clear in-frame 3-nt periodicity. As the read length after offset correction is 1, put the parameter “-d” as “1”. 
